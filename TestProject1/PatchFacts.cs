...
public class PatchFacts(ITestOutputHelper _ctx)
{
    ...
    public void Patch_Developer()
    {
        var payload = new Developer()
        {
            ...
            {
                ProjectUid      = "PRJ-12345",
                ProjectExposure = DeveloperProjectExposureStatus.UnderExposed.ToString()
            }
            ]
        };
