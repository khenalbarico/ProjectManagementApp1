namespace ProjectManagement1.Models.Constants;
...
public class DeveloperImagePaths
{
    ...
    public const string MarcusName  = "Marcus";
    public const string PoloName    = "Polo";
    ...
    public const string Marcus  = "imgs/Marcus.jpg";
    public const string Polo    = "imgs/Polo.jpg";
    public const string Mabi    = "imgs/Mabi.jpg";
    public const string Marlou  = "imgs/Marlou.jpg";
}